...
attack = instance_create(0, 0, StateTemplate);       // represents normal, stationary resting
  attack.main = FireBoss_Attack;   
  attack.onEnter = FireBoss_Attack_OnEnter;                   // link Player_Stand as script for step event
...
special = instance_create(0, 0, StateTemplate);
  special.main = FireBoss_Special;
  special.onExit = FireBoss_Special_OnExit;
